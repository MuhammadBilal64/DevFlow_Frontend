    ...
    <div className="mb-4">
      ...
      <div className="relative flex items-center">
        <input
          ...
          className={`w-full surface-input rounded-lg border-[#30363D] bg-[#0D1117] px-3.5 py-2.5 text-sm text-[#F0F6FC] placeholder:text-slate-500 outline-none transition ${
      ...
      {error && (
        <p className="mt-1 text-xs text-rose-400 font-normal">
          {error}
        </p>
      )}
    </div>
